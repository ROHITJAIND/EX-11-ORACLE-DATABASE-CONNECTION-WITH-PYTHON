...
### AIM:
To connect Oracle database with Python using cx_Oracle module.&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;   **DATE :** 31.10.2023  
### PROCEDURE:
...
#### PROGRAM:
```python
# importing module                                                                      Developed By: ROHIT JAIN D
import cx_Oracle                                                                        Register No: 212222230120
...
# by writing finally if any error occurs then also we can close the all database operation
finally:
	if cursor:
		cursor.close()
	if con:
...
try:
	...
	try:
		...
		cur = con.cursor()
		# Inserting multiple records into employee table (:1,:2,:3) are place holders. They pick data from a list supplied as argument
